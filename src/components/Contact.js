    ...
    <div>
      <div className=" shadow-md">
        <div className="flex justify-center mx-auto">
          ...
          <img src="https://media.istockphoto.com/id/1187826963/vector/headset-icon-music-templates.jpg?s=612x612&w=0&k=20&c=GKmiQTaQLxpb1R0_3b7M6TW_fTKvfzanuZlU7kDsG-A=" alt="headphone" className="w-8 my-auto" />
        </div>
        ...
        <div className="flex justify-between">
          ...
          <form className="border-2  w-[40rem] p-8  mr-10 mt-8 rounded-3xl mb-8 shadow-2xl shadow-gray-500">
            ...
            <div className="text-center"><button className="mx-auto  bg-green-700 hover:bg-red-600 text-sm text-white font-bold w-24 h-10 mt-7 shadow-md border-2 " >Submit</button></div>
          </form>
        </div>
      </div>
    </div>
